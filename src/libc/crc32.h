 ...
 *
 * @subsystem libc
 * @brief ellenörzőösszeg számító eljárások
 */

#ifndef _CRC32C__
#define _CRC32C__

/* előregenerált CRC32c tábla a 0x1EDC6F41 polinómhoz (castagnoli-crc) */
...
/* előregenerált crc tábla az EFI-s polinómhoz (ansi-crc) */
 ...
 */
public uint32_t crc32c_calc(char *start, size_t length)
{
 ...
 */
public uint32_t crc32a_calc(char *start, size_t length)
{
